  ...
  const handleAction = async (action) => {
    try {
      if (usuario.desplazamientos <= 0 && usuario.lvl_premium !== 2) {
        ...
        setResetPosition(true);  // Set the flag to true to avoid animation
                ...
                {currentIndex < usuariosSwipe.length && (
                  ...
                  >
                    <div className="flex flex-col items-center p-4">
                      ...
                      <h3 className="text-xl font-Swipe text-white">{usuariosSwipe[currentIndex].likes}</h3>
                    ...
                    <div className="bg-opacity-10 bg-gray-800 flex flex-col items-center justify-center">
                      ...
                      <h3 className="text-white font-montserrat mt-1">Posición</h3><span className="font-Swipe mb-1">{conexion.posicion ? conexion.posicion : 'cargando...'}</span>
                    </div>
                  </motion.div>
                )}
