...
const Tarjetas = () => {
  ...
  return (
    ...
    {/* <div className='bg-red-500 rounded-full w-6 p-1 m-5 hover:cursor-pointer' onClick={home}><img src="data:image/png;base64,"/></div> */}
        <div className='flex w-full p-2 align-center'>
          <div class="flex flex-col p-2 border-2 border-red-300 rounded  items-center justify-center h-full">
        ...
        <div className="w-full lg:w-1/2 lg:pl-8 m-5">
