                ...
                {token ? (
                    <div className='bg-gray-300 py-10 md:py-0 md:pt-24 md:pb-28'>
                        ...
                        <div className="grid 2xl:px-64 p-10 text-zinc-800 cuatro:justify-center xl:grid-cols-3 xl:ml-4 2xl:ml-0">
                            ...
                            <div className="flex flex-col items-center bg-gradient-to-br from-red-200 via-red-300 to-red-400 p-8 rounded-lg shadow-lg relative border-8 border-red-500 max-w-sm mb-10 xl:mb-0 2xl:ml-0 xl:ml-4">
