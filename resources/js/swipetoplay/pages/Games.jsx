...
const Games = () => {
  ...
  <div className='w-1/2 flex justify-center'>
  <a target='_blank' href='https://www.leagueoflegends.com/es-es/'><img src={Lol} className='hover:border-2 hover:border-blue-600 w-2/3 m-auto transform transition-transform duration-300 ease-in-out hover:scale-110 hover:shadow-custom hover:shadow-custom-blue rounded-xl'/></a>
  </div>
</div>
